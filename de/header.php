...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title : "Maremma Che Sagra | Food Festivals & Lokale Traditionen in der Maremma, Toskana"; ?></title>
...
<body>
    <header>
       ...
       <?php 
        ...
        <ul>
            <li><a href="<?php echo ($current_page === 'index.php') ? '#home' : 'index.php#home'; ?>">Startseite</a></li>
            <li><a href="<?php echo ($current_page === 'index.php') ? '#eventi' : 'index.php#eventi'; ?>">Veranstaltungen</a></li>
            <li><a href="<?php echo ($current_page === 'index.php') ? '#contatti' : 'index.php#contatti'; ?>">Sponsoring</a></li>
        </ul>
        </nav>
