...
<div id="cookie-banner" role="region" aria-label="Cookie-Zustimmungsbanner">
  <div>
    Diese Website verwendet technische Cookies, um Ihr Erlebnis zu verbessern. 
    <a href="privacy.php" target="_blank" rel="noopener">Lesen Sie unsere Datenschutzrichtlinie</a>.
  </div>
  <div>
    <button id="accept-cookies">Akzeptieren</button>
    <button id="reject-cookies" class="reject">Ablehnen</button>
  </div>
</div>
