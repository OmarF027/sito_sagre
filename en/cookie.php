...
<div id="cookie-banner" role="region" aria-label="Cookie consent banner">
  <div>
    This site uses technical cookies to improve your experience. 
    <a href="privacy.php" target="_blank" rel="noopener">Read our Privacy Policy</a>.
  </div>
  <div>
    <button id="accept-cookies">Accept</button>
    <button id="reject-cookies" class="reject">Reject</button>
  </div>
</div>
